    ...
    **/
        ...
        returns (Types.VerificationKey memory)
    {
        ...
        assembly {
            ...
            mstore(
                mload(add(vk, 0xa0)),
                0x18d878f5189ea6b5e28e0c01fb6f01247c7c23c81d4e275be56a9a409b8fbc86
            ) //vk.Q1
            mstore(
                add(mload(add(vk, 0xa0)), 0x20),
                0x15006407a9eb5ff6be2dadab9295de1b92a9e40b0ee60726f69781a31fc4829c
            )
            mstore(
                mload(add(vk, 0xc0)),
                0x07f64e935c37bc021f2149fcb653b709d4766abaf5319a2a8c08b95d711c5f9f
            ) //vk.Q2
            mstore(
                add(mload(add(vk, 0xc0)), 0x20),
                0x0377d32b84597d52f8ef02aed80cd37588770fe7141aee994a7e0ebe0f2d0024
            )
            mstore(
                mload(add(vk, 0xe0)),
                0x0dac54927f0650c37ea0672ed11142ebd759d52145e1322ac0e6f3a643a2184e
            ) //vk.Q3
            mstore(
                add(mload(add(vk, 0xe0)), 0x20),
                0x2cdd5e5007e826b5fc7c5a8c81b4edc4e2fc26111f1137c98bf4152ab7966a4a
            )
            mstore(
                mload(add(vk, 0x100)),
                0x2a31a775698656d8288651659c06f3b86431b580c86e6dd908b84fcddf1c51e4
            ) //vk.Q4
            mstore(
                add(mload(add(vk, 0x100)), 0x20),
                0x1ffd14fc8f958861ff17a08d9d9004a92ed6e30f57b5ed18c99f3f6bac562238
            )
            mstore(
                mload(add(vk, 0x120)),
                0x292ead0bbe8fd1e838878f2cb6eaac20b0e3d69cc7169ccbe786d2d14aa11b3a
            ) //vk.Q5
            mstore(
                add(mload(add(vk, 0x120)), 0x20),
                0x2ccd322e48057f8190ab0f7f8693e2fadf1ac14da09ae0782dcdc4486acea0c9
            )
            mstore(
                mload(add(vk, 0x140)),
                0x02f5f0fcd5523d00c3eb9ea29e56f23d6a5239ae6b21cb86a717823df5442f6f
            ) //vk.QM
            mstore(
                add(mload(add(vk, 0x140)), 0x20),
                0x1aca825aa9add2c3bfb575a6207fae2fde4f8591363a04f165d0ab1e7344157f
            )
            mstore(
                mload(add(vk, 0x160)),
                0x117c54b5fe353f5b6566e775277bf944f222b396c0f85ccaeaa3bbe23c2b779b
            ) //vk.QC
            mstore(
                add(mload(add(vk, 0x160)), 0x20),
                0x1f86314d9a79ce9aa413533b40f8d482cd65d26ff2e2e7a823cdcd35e954ffcb
            )
            mstore(
                mload(add(vk, 0x180)),
                0x1bd215ad3217ed1f1342d9148f9975cb03647ae10f063884189450d06e374ce3
            ) //vk.QARITH
            mstore(
                add(mload(add(vk, 0x180)), 0x20),
                0x1a38c7a38c0fac0842640360e9c18d3ea239e34f260a5bb71c387236b4893bec
            )
            mstore(
                mload(add(vk, 0x1a0)),
                0x1b2a75889690fbcc9b9894057ceced79a3d505974f32e43b7980c3335e3c5004
            ) //vk.QECC
            mstore(
                add(mload(add(vk, 0x1a0)), 0x20),
                0x1a0027a54084e86d50bc3eff2dffd256410d95545f6a6c3b1260203c9ebe0ce3
            )
            mstore(
                mload(add(vk, 0x1c0)),
                0x241300825f029e9e83832c6507b7108c68893be2737ad0777f3b6fc2868562d0
            ) //vk.QRANGE
            mstore(
                add(mload(add(vk, 0x1c0)), 0x20),
                0x0fed6894ed194267692c345e019c3b5e99668fc3cfef574b3621efe55d4c6e06
            )
            mstore(
                mload(add(vk, 0x1e0)),
            ...
            mstore(
                mload(add(vk, 0x200)),
                0x23cc98bc84c16d19f8141f5dc4396c226771ee8febb0f6cdd73de3a4d347e905
            ) //vk.SIGMA1
            mstore(
                add(mload(add(vk, 0x200)), 0x20),
                0x286bd81d1e3d2a34edf73028398ffa463fbf48a32db96f50f115aaf6c7ebde01
            )
            mstore(
                mload(add(vk, 0x220)),
                0x20cf4a8770cd0635a179fce1e977714df6a06dc5610ebc3f4dafaab9d6fabc62
            ) //vk.SIGMA2
            mstore(
                add(mload(add(vk, 0x220)), 0x20),
                0x1fbd5d25921ee4f3e9434b4b2b36a5d752171828f9872af0344ea1bdb0b1cb57
            )
            mstore(
                mload(add(vk, 0x240)),
                0x0a2588ac926001f041d3513bbbdbfef2a29752562d3b55157529088363f6dfd8
            ) //vk.SIGMA3
            mstore(
                add(mload(add(vk, 0x240)), 0x20),
                0x228542a2d603d1e0204055fa86e3bb90f5c196b24d8b74a0bc3601ee9cd0930b
            )
            mstore(
                mload(add(vk, 0x260)),
                0x1ebb2d46e8c2b7620284055c8972a5ac034a2af7536c98e840e0717ffa4f6a66
            ) //vk.SIGMA4
            mstore(
                add(mload(add(vk, 0x260)), 0x20),
                0x0da550331e42a50b68b85eb20ea179ee08e538e4850c5e86cba8dbd385427e0e
            )
